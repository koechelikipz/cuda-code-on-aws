...
Please see this [documentation page](https://www.mathworks.com/help/images/code-generation-for-image-processing.html) for more information on how to use image processing functions in code generation. Alternatively, you can also use the OpenCV library to read images.
